...
dt_lomb       = read_csv(file_path[1], col_types = cols( .default = "c"), locale = readr::locale(encoding = "latin1"))
dt_global     = read_csv(file_path[2], col_types = cols( .default = "c"), locale = readr::locale(encoding = "latin1"))
...
```{r}
dt_population=dt_population%>%select(c("ï..ITTER107",'Territorio','Sesso','Value'))
```
